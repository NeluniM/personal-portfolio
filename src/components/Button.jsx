...
export const Button = ({ className = "", size = "default", children, type = "button", disabled = false, ...props }) => {
   ...
   const sizeClasses = {
    ...
    const classes = `${baseClasses} ${sizeClasses[size]} ${disabled ? "opacity-60 cursor-not-allowed hover:bg-primary" : ""} ${className}`;
    return (
